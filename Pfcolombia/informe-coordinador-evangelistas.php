...
if(isset($_REQUEST["excelXML"])){
    ...
    */
    ...
    LEFT JOIN categorias AS C ON C.id = UE.empresa_pd ";
    //
    $sql.=" WHERE 1 ".$sqlFiltro." AND sat_reportes.rep_tip = 318 GROUP BY sat_reportes.idUsuario ORDER BY U.nombre ASC";
...
<div class="container">
    <form name="form" id="form" method="get" class="form-horizontal">
        <input type="hidden" name="doc" value="informe-coordinador-evangelistas" />
        <div>
