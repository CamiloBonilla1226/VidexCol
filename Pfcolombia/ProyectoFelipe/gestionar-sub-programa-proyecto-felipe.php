        ...
        */
        ...
        if($archivo1 != ""){
            ...
            if ($asistencia_nin > 0) {
                ...
                $act_grad_cur = $_REQUEST['act_grad_cur'];
                ...
                for ($i=0; $i < sizeof($act_grad_tar); $i++) { 
                    $sql .= "('".$act_grad_nom[$i]."','".$act_grad_tar[$i]."','".$act_grad_cur[$i]."','".date('Y-m-d')."',1,".$ultimoId."),";
                }
                $sql = substr($sql, 0, -1);
                //echo $sql;
                $ultimoQuery = $PSN1->query($sql);
        ...
        */
        ...
        for ($i=0; $i < $num_grad_nue; $i++) {
            ...
            $sqlA = "REPLACE INTO tbl_adjuntos (adj_id,adj_nom,adj_url,adj_fec,adj_can, adj_tip,adj_rep_fk)";
                $sqlA .= "VALUES (0".$act_grad_id[$i].",'".$act_grad_nom[$i]."','".$act_grad_tar[$i]."','".date('Y-m-d')."','".$act_grad_cur[$i]."',1,".$idReporteActual."); ";
            //echo $sqlA;
            $PSN1->query($sqlA);
        }
        $num_vin_ant = 0;
...
LEFT JOIN categorias AS CA ON CA.id = C.idSec";
    ...
    if($PSN1->num_rows() > 0)
    {
        ...
        <div class="form-group">
            <center><input type="button" onClick="window.location.href='index.php?doc=consultar-sub-programa-proyecto-felipe'" name="previous" class="previous btn btn-danger" value="Cerrar" /> <br />
        </div>
        <?php
        exit;
    }
        ...
        <h3 class="alert alert-info text-center"><?php
            ...
            <div class="cont-btn cont-flex fl-sbet">
                <div class="item-btn">
                    <?php
                    if ($antId != 0) {?>
                    <a href="index.php?doc=gestionar-sub-programa-proyecto-felipe&id=<?=$antId ?>" name="previous" class="previous btn btn-info">Anterior reporte <?=$antId ?></a>
                    <?php } ?>
                </div>
                <div class="item-btn">
                    <a href="index.php?doc=consultar-sub-programa-proyecto-felipe" name="previous" class="btn btn-warning">Todos los reportes</a>
                </div>
                <div class="item-btn">
                    <?php
                    if ($sigId != 0) {?>
                    <a href="index.php?doc=gestionar-sub-programa-proyecto-felipe&id=<?=$sigId ?>" name="previous" class="previous btn btn-info">Siguiente reporte <?=$sigId ?></a>
                    <?php } ?>
                </div>
            </div>
    <?php //} ?>
    ...
    ?> 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                ...
                <select name="mapeo_cuarto" readonly class="form-control">
                    <?php echo($mapeo_cuarto== "1")?'<option value="1" selected >Q1 (Ene - Mar)</option>':''; ?>
                    <?php echo($mapeo_cuarto== "4")?'<option value="4" selected >Q2 (Abr - Jun)</option>':''; ?>
                    <?php echo($mapeo_cuarto== "7")?'<option value="7" selected >Q3 (Jul - Sep)</option>':''; ?>
                    <?php echo($mapeo_cuarto== "10")?'<option value="10" selected >Q4 (Oct - Dic)</option>':''; ?>
                </select>
            </div>
            <div class="col-sm-3">
                <strong>Patio en el que se realizó el curso:</strong>
        ...
        <div class="cont-tit">
            ...
            <div class="tit-cen">
                ...
                <h5>Modifique los datos requeridos</h5>
            </div>
            <div class="hr"><hr></div>
        </div>
        <div class="form-group">
            <div class="col-sm-3">
                <strong>Número de prisioneros invitados al curso:</strong>
                <input name="asistencia_total" type="number" id="asistencia_total" value="<?=$asistencia_total; ?>" class="form-control"  />
            </div>
            <div class="col-sm-3">
                <strong>Número de prisioneros inscritos en el curso:</strong>
                <input name="asistencia_hom" type="number" id="asistencia_hom" value="<?=$asistencia_hom; ?>" class="form-control"  />
            </div>         
            <div class="col-sm-3">
                <strong>Número de prisioneros que iniciaron el curso:</strong>
                <input name="asistencia_muj" type="number" id="asistencia_muj" value="<?=$asistencia_muj; ?>" class="form-control"  />
            </div>
            <div class="col-sm-3">
                <strong>Total de cursos completados de proyecto Felipe:</strong>
                    ...
                    if($numero > 0){
                        while($PSN1->next_record()){ ?>
                            ...
                            <tr <?php echo($cont==0)?'class="fila-fijaAdd"':''; ?>>
                                ...
                                <td class="col-sm-4">
                                    <strong>Curso de graduación:</strong>
                                    <select name="act_grad_cur[]" id="act_grad_cur" class="act_grad_tar form-control">
                                        <?php
                                            $sql = "SELECT * ";
                                            $sql.=" FROM categorias AS C";
                                            $sql.=" WHERE C.idSec = 87 ";
                                            $PSN2->query($sql);
        ...
        <div class="cont-tit">
            <div class="hr"><hr></div>
            <div class="tit-cen">
                <h3 class="text-center">INFORMACIÓN DE VOLUNTARIOS INTERNOS</h3>
                <h5>Modifique los datos requeridos</h5>               
            </div>
            <div class="hr"><hr></div>
        </div>
                ...
                <script>
                    $(function(){
                        ...
                        $("#adicionarAdd2").on('click',function(){
                            $("#tablaAdd2 tbody tr:last").clone().removeClass('fila-fijaAdd2').appendTo("#tablaAdd2");
        ...
        <div class="cont-tit">
            <div class="hr"><hr></div>
            <div class="tit-cen">
                <h3 class="text-center">INFORMACIÓN DE VOLUNTARIOS EXTERNOS</h3>
                <h5>Modifique los datos requeridos</h5>               
            </div>
            <div class="hr"><hr></div>
        </div>
                ...
                <script>
                    $(function(){
                        ...
                        $("#adicionarAdd3").on('click',function(){
                            $("#tablaAdd3 tbody tr:last").clone().removeClass('fila-fijaAdd3').appendTo("#tablaAdd3");
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    if($ext2 == "" || !file_exists("archivos/evi_".$idReporteActual."_2.".$ext2)){
                        ...
                        <a href="archivos/evi_<?=$idReporteActual; ?>_2.<?=$ext2; ?>" target="_blank"><i class="fas fa-file-pdf"></i> Ver documento</a>
                    <?php }?><br>
                    <strong>Adjuntar archivo:</strong>
                    <input name="archivo2" type="file" id="archivo2" class="form-control" /><br>
                    <strong>¿Qué funcionó?:</strong>
                    <textarea name="rep_text1" id="rep_text1" style="width: 100%; max-width: 100%; min-width: 100%;" class="form-control"><?php echo $rep_text1; ?></textarea>
                </div>
                <div class="col-sm-5">
                    <strong>Foto:</strong>
                    <?php
...
if($idReporteActual > 0){
    //No hacemos nada.
        ...
        <div class="row">
            <h2 class="alert alert-success text-center"><a href="index.php?doc=gestionar-sub-programa-proyecto-felipe&opc=2&id=<?=$ultimoId; ?>" class="h2">Se ha <?php
            if($idReporteActual == 0){
                echo "creado";
            }
            else{
    ...
    <!-----FORMULARIO DE REGISTO LPP---->
       ...
       <!--<fieldset>--><div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <strong>Total de cursos completados de proyecto Felipe:</strong>
                        <input name="asistencia_jov" type="number" id="asistencia_jov" min="0" value="" class="form-control" readonly />
                    </div>   
                </div>
                <!--<div class="cont-btn cont-flex fl-sbet">
                    <div class="item-btn">
        ...
        <!--REGISTRO DE GRADUADOS--->
            <!--<fieldset>--><div class="col-sm-12">
                    ...
                    <div class="col-sm-8">
                        <script>
                            $(function(){
                                ...
                                if (tar == "" || nom == "") {
                                    $("#adicionarAdd").prop( "disabled", true );
                                    $("#atras_grad").prop( "disabled", true );
                                    
                                }else{
                                    $("#adicionarAdd").prop( "disabled", false );
                                    $("#atras_grad").prop( "disabled", false );
                                }
                ...
                <!--<div class="cont-btn cont-flex fl-sbet">
                    <div class="item-btn">
                        <input type="button" id="atras_grad" name="previous" class="previous btn btn-info" value="Anterior" />
                    </div>
                    <div class="item-btn">
                        <input type="button" name="next" id="archivo1_sig" class="next btn btn-success" value="Siguiente" />
                    </div>
        ...
        <!--REGISTRO DE VOLUNTARIOS INTERNOS-->
            <!--<fieldset>--><div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <table id="tablaAdd2">
                            <tr class="fila-fijaAdd2">
                                <td class="col-sm-7">
                                    <strong>Nombre del voluntario interno:</strong>
                                    <input name="act_vin_nom[]" type="text" id="act_vin_nom" class="act_vin_nom form-control" />
                                </td>
                                <td class="col-sm-4">
                                    <strong>Tarjeta dactilar / N° identificación:</strong>
                ...
                <div class="form-group">
                    <div class="col-sm-2"></div>
                    <div class="col-sm-8">
                        <div class="col-sm-4"><strong>Número total de voluntarios internos:</strong> </div>
                        <div class="col-sm-2">
        ...
        <!--REGISTRO DE VOLUNTARIOS EXTERNOS--->
            <!--<fieldset>--><div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <table id="tablaAdd3">
                            <tr class="fila-fijaAdd3">
                                <td class="col-sm-7">
                                    <strong>Nombre del voluntario externo,:</strong>
                                    <input name="act_vex_nom[]" type="text" id="act_vex_nom" class="act_vex_nom form-control"  />
                                </td>
                                <td class="col-sm-4">
                                    <strong>N° identificación:</strong>
                ...
                <div class="form-group">
                    <div class="col-sm-2"></div>
                    <div class="col-sm-8">
                        <div class="col-sm-4"><strong>Número total de voluntarios externos:</strong> </div>
                        <div class="col-sm-2">
