...
$nombreGrafica ="SOCIEDAD MISIONERA DEL ECUADOR";
?>
...
<? /*                <h2 style="margin-top: -5px;font-size: 28px; "><?=$gloPrograma; ?> de la</h2>
                ...
                <br/>
<!--                 <h1 style="margin-top: -14px;font-size: 32px;"><?=" Ministerio Cada Comunicad para Cristo"; ?>.</h1> -->
                <p style="margin: 0px">Desde aquí usted podrá contar con toda la información a tan solo un clic de distancia.</p>
                <ul class="social">
                    <li class="social-item"><a href="https://sociedadmisionera.org/" target="_blank"><i class="fas fa-globe-americas"></i></a></li>
<?/*                    <li class="social-item"><a href="https://www.facebook.com/pfcolombia.org/" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <li class="social-item"><a href="https://x.com/" target="_blank"><i class="fab fa-twitter"></i></a></li>
                </ul>
            </div>    
        </div>
    </div>
    <div style="width: 100%;" >
        ...
        <div class="t-container">
            <ul class="t-tabs">
                <li class="t-tab">C.C. para Cristo</li>
