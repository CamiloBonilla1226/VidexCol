...
/*
 * ajax_info_grupo.php
 * Endpoint JSON usado por gestionar-capacitador.php para mostrar la
...
/*
*   El grupo debe pertenecer al usuario de sesión y ser tipo_actividad = 308
*   (Capacitadores), salvo que sea el grupo OMS (generación 0), disponible
*   para todos (misma regla aplicada en gestionar-capacitador.php).
*/
...
$sql .= "AND (tipo_actividad = 308 OR generacion = 0) LIMIT 1";
$PSN1->query($sql);
