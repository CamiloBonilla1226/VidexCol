<?php
/*
*   Gráfica de consolidado del programa Capacitadores (ecu_reportes,
*   tipo_reporte = 308). Inspirada en grafica-consolidado-evangelistas.php
*   (mismo tipo de filtros y Google Charts), pero sobre la tabla nueva y con
*   el estilo visual .ecu-wrap ya usado en gestionar-capacitador.php /
*   reportar_capacitador.php / consultar-capacitador.php / editar_capacitador.php.
...
/*
*   Mismo criterio de permisos que consultar-capacitador.php: el admin
*   (usuario.tipo = 2) ve el consolidado de TODOS los capacitadores;
...
<div class="ecu-wrap">
    ...
    <div class="ecu-card">
        ...
        <form method="get" id="formFiltrosGrafica">
            <input type="hidden" name="doc" value="grafica-capacitador" />
...
<script type="text/javascript">
    ...
    google.charts.setOnLoadCallback(dibujarGraficasCapacitadores);

    function dibujarGraficasCapacitadores(){
