<?php
/*
*   Pantalla de selección/creación de grupo para el programa Capacitadores.
...
*   Facilitadores, 308 = Capacitadores/ECC). Este archivo solo crea grupos de
*   Capacitadores, así que queda fijo en 308 — el usuario nunca lo escribe
...
if(isset($_POST["funcion"]) && $_POST["funcion"] == "crear_grupo"){
    ...
    if($nombre_grupo == ""){
        ...
        if($grupo_anterior > 0){
            ...
            *   con id_usuario del admin/sistema, no del capacitador).
            */
...
*   pertenecer al usuario de sesión y ser de tipo_actividad = 308
*   (Capacitadores) — salvo que sea el grupo OMS (generación 0), que
...
*   (tipo_actividad = 308 (Capacitadores) o generación 0 — el grupo OMS
    ...
    <div class="ecu-fila-inferior">
        ...
        <div class="ecu-card ecu-panel-reporte">
            <div class="ecu-panel-header">
                ...
                <a href="<?php echo $puedeGenerarReporte ? 'index.php?doc=reportar_capacitador&idgrupo='.$idGrupoSeleccionado : '#'; ?>"
                   id="ecuBtnReporte"
        ...
        */
        ...
        function actualizarBotonReporte(idGrupo, generacion){
            ...
            if(idGrupo && parseInt(generacion, 10) !== 0){
                btnReporte.href = 'index.php?doc=reportar_capacitador&idgrupo=' + encodeURIComponent(idGrupo);
        ...
        function cargarInfoGrupo(idGrupo){
            ...
            fetch('ajax_info_grupo_capacitador.php?idgrupo=' + encodeURIComponent(idGrupo), { credentials: 'same-origin' })
