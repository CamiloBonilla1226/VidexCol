<?php
/*
 * ajax_eliminar_reporte_capacitador.php
 * Endpoint JSON usado por editar_capacitador.php para eliminar un reporte
 * de Capacitadores (ecu_reportes, tipo_reporte = 308), incluida su foto
 * física si tiene una.
 */
session_start();
...
$sqlReporte = "SELECT foto FROM ecu_reportes WHERE idreporte = ".$idReporte." AND tipo_reporte = 308 LIMIT 1";
...
*   sean (ver editar_capacitador.php: los demás usuarios solo pueden
...
if($foto != ""){
    $rutaFoto = "archivos/capacitador_".$idReporte.".".$foto;
